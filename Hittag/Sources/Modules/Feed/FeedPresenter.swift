...
final class FeedPresenter: Presenter, FeedPresenterType {
    ...
    override func start() {
        ...
        let azeitao = User(name: "Téo",
                           image: URL(string: "https://scontent.fcgh22-1.fna.fbcdn.net/v/t1.0-9/1234969_557061524342713_357135411_n.jpg?_nc_cat=105&_nc_ht=scontent.fcgh22-1.fna&oh=a136f843a576923137098db2785ef0b8&oe=5CBD129E")!,
                           hittags: [])
        
        let posts = [
            Post(text: "Encontrei o Sacana!",
                 image: URL(string: "https://instagram.fcgh22-1.fna.fbcdn.net/vp/5df3c6d819804e4ad64eb6a339e41dae/5CC1380C/t51.2885-15/sh0.08/e35/p640x640/49784279_596634510760891_5024978615261294605_n.jpg?_nc_ht=instagram.fcgh22-1.fna.fbcdn.net")!,
                 hashtags: [Hashtag(name: "#fuscao"), Hashtag(name: "#fuscaazul"), Hashtag(name: "#vacation"), Hashtag(name: "#acheiosafado")],
                 user: eu),
            Post(text: "Encontrei o Sacana!",
                 image: URL(string: "https://imganuncios.mitula.net/volkswagen_fusca_1970_fusca_4830008519744234296.jpg")!,
                 hashtags: [Hashtag(name: "#fuscao")],
                 user: azeitao),
